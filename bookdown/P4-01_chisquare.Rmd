...
In any case, **categorical data analysis** refers to a collection of tools that you can use when your data are nominal scale. We can use many tools for categorical data analysis, but this chapter covers the ones used by CogStat and some more common ones.
...
(ref:cogstatloadcardscap) Loading the cards.csv data and running `Explore variable` command on `choice_1`

```{r cogstatloadcards, echo=FALSE, fig.cap=paste("(ref:cogstatloadcardscap)"), fig.align="center", fig.show="hold"}
knitr::include_graphics(c("resources/image/cogstatloadcards.png",
                  "resources/image/cogstatcardsdescrhisto.png"))
```
...
```{r echo=FALSE}
knitr::kable(data.frame(stringsAsFactors=FALSE,
N = c("Expected frequency", "Observed frequency",
         "Difference score"),
...
(ref:manychicap) Chi-square distributions with different values for the "degrees of freedom".

```{r manychi, fig.cap=paste("(ref:manychicap)"), echo=FALSE, fig.align="center"}
chiSqImg <- list()
emphCol <- rgb(0,0,1)
...
(ref:cogstatloadchapek9cap) Loading the [`chapek9.csv`](resources/data/chapek9.csv) data set into CogStat.

```{r cogstatloadchapek9, echo=FALSE, fig.align="center", fig.show="hold", fig.cap=paste("(ref:cogstatloadchapek9cap)")}
knitr::include_graphics("resources/image/cogstatloadchapek9.png")
```
...
knitr::include_graphics("resources/image/cogstatcomparegroupschapek9.png")
```
...
knitr::include_graphics("resources/image/cogstatchapek9mosaic.png")
```
...
knitr::include_graphics("resources/image/cogstatchapek9descriptives.png")
```
...
```{r cogstatchapek9hypo, fig.cap="Population properties and Hypothesis tests for the `chapek9.csv` data set.", echo=FALSE, fig.align="center"}
knitr::include_graphics("resources/image/cogstatchapek9hypo.png")
```

Let us go through the `Hypothesis tests` section line by line.

```{r, eval=knitr::is_html_output(), echo=FALSE}
htmltools::includeHTML("resources/html/hyp1.html")
```

```{r, echo=FALSE}
if (knitr::is_latex_output()) {
  knitr::asis_output(
      xfun::file_string("resources/html/hyp1.txt")
  )
}
```
...
(ref:chapek9twocap) CogStat results for [`chapek9two.csv`](resources/data/chapek9two.csv) with 1 degree of freedom

```{r chapek9two, fig.cap=paste("(ref:chapek9twocap)"), fig.align="center", fig.show="hold", echo=FALSE}
knitr::include_graphics(c("resources/image/cogstatchapek9twomatrix.png",
                    "resources/image/cogstatchapek9tworesult.png"))
```
...
## Effect size (Cramér's $V$){#chisqeffectsize}
...
```{r, eval=knitr::is_html_output(), echo=FALSE}
htmltools::includeHTML("resources/html/effect1.html")
```

```{r, echo=FALSE}
if (knitr::is_latex_output()) {
  knitr::asis_output(
      xfun::file_string("resources/html/effect1.txt")
  )
}
```
...
```{r cogstatsalemload, echo=FALSE, fig.align="center", fig.cap="The `salem` data set"}
knitr::include_graphics("resources/image/cogstatsalemload.png")
```
...
```{r cogstatsalemresult, echo=FALSE, fig.align="center"}
knitr::include_graphics("resources/image/cogstatsalemresult.png")
```

We'd *really* like to be able to get a better answer than this provided we really don't want to be on fire. This is where **Fisher's exact test** [@Fisher1922] comes in very handy. The Fisher exact test works somewhat differently to the chi-square test (or in fact any of the other hypothesis tests in this book) insofar as it doesn't have a test statistic; it calculates the $p$-value "directly".
...
```{r cogstatloadagpp, echo=FALSE, fig.align="center"}
knitr::include_graphics("resources/image/cogstatloadagpp.png")
```
...
```{r cogstatrepeatagpp, echo=FALSE, fig.align="center", fig.cap="Repeated measures analysis of the AGPP data in CogStat."}
knitr::include_graphics("resources/image/cogstatrepeatagpp.png")
```

```{r cogstatagppresults, echo=FALSE, fig.align="center", fig.cap="Results of the repeated measures analysis of the AGPP data in CogStat.", fig.show="hold"}
knitr::include_graphics(c("resources/image/cogstatagppresults1.png",
                          "resources/image/cogstatagppresults2.png"))
```

```{r, eval=knitr::is_html_output(), echo=FALSE}
htmltools::includeHTML("resources/html/hyp2.html")
```

```{r, echo=FALSE}
if (knitr::is_latex_output()) {
  knitr::asis_output(
      xfun::file_string("resources/html/hyp2.txt")
  )
}
```
...
```{r, eval=knitr::is_html_output(), echo=FALSE}
htmltools::includeHTML("resources/html/hyp3.html")
```

```{r, echo=FALSE}
if (knitr::is_latex_output()) {
  knitr::asis_output(
      xfun::file_string("resources/html/hyp3.txt")
  )
}
```

```{r cogstatmcn, echo=FALSE, fig.align="center", fig.show="hold", fig.cap="Hypothesis test results when running either `Compare repeated measures variables` or `Explore relation of variable pair` in CogStat."}
knitr::include_graphics(c("resources/image/cogstatmcn1.png",
                        "resources/image/cogstatmcn2.png"))
```
