...
```{r cogstatloadcards, echo=FALSE, fig.cap=paste("(ref:cogstatloadcardscap)"), fig.align="center", out.width="100%", fig.show="hold"}
...
```{r chapek9two, fig.cap=paste("(ref:chapek9twocap)"), fig.align="center", out.width="100%", fig.show="hold", echo=FALSE}
