...
```{r scatterparent1a, fig.align='center',echo=FALSE, fig.cap="Scatterplot drawn by CogStat showing the relationship between `parentsleep` and `parentgrump`"}
knitr::include_graphics("resources/image/parentsleepgrumpplot.png")
```

```{r scatterparent1b, fig.align='center',echo=FALSE, fig.cap="Scatterplot drawn by CogStat showing the relationship between `babysleep` and `parentgrump`"}
