...
```{r loadparenthood, out.width='100%', fig.align='center',echo=FALSE, fig.cap="This is what you would see after loading the parenthood.csv dataset."}
...
```{r parenthoodmissing, echo=FALSE, fig.align='center', out.width='100%', fig.cap="This is what you would see in CogStat after loading the adjusted dataset."}
