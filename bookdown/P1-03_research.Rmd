...
knitr::kable(
 ...
 , caption = 'The relationship between the measurement scales and the discrete/continuity distinction. Cells with a tick mark correspond to things that are possible.', align="lcc",
 booktabs = TRUE,
 escape = FALSE
)
```
...
### How to set measurement levels for use in CogStat{#setlevels}
