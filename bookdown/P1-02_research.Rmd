...
- ***Test-retest reliability***. This relates to consistency over time: if we repeat the measurement on the same thing at a later date, do we get the same answer? In Example \@ref(exm:exreliability1), the scale in Room A was not reliable, but the scale in Room B and Room C was.
