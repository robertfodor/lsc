...
- Does the construct have a "precise conceptual and theoretical meaning"? [@marksResearchMethodsClinical2004, p. 132]
...
The **discriminant validity**^[Sometimes referred to as *divergent validity*. This, however, is not a universally accepted terminology [@hubleyDivergentValidity2014].] assesses the extent to which a measure is capable of accurately distinguishing the construct variable it is intended to measure from an unrelated construct variables. It is the opposite of convergent validity.
:::

Types of questions you might consider:

- What is the correlation between the variable we are measuring and other variables that should not be related to it? --> *discriminant validity coefficient*
...
- What is the correlation between the variable we are measuring and other variables that should be related to it? --> *correlation coefficient*

::: {.example #exconstructvalidity name="Example: Construct validity, convergent validity, discriminant validity, and confounding variables"}
