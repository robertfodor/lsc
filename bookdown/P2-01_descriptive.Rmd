...
```{r echo=FALSE, fig.align="center", fig.cap = "Density plot with mean."}
library(ggplot2)
...
ggplot(data, aes(x = data_set_a)) +
  geom_density(aes(y = ..density..), fill = "#0096c8", alpha = 0.5) +
...
```{r echo=FALSE, fig.align="center", out.width="45%", fig.cap="(ref:quartilefigcap)"}
