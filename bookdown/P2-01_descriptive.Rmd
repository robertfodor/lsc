...
:::: {.callout #summation data-latex=""}
::: {.callouttitle data-latex=""}
**Summation symbol**: $\scriptstyle\sum$ and **Product symbol**: $\scriptstyle\prod$ notations
:::
\nopagebreak
...
:::: {.callout #calloutquantile data-latex=""}
::: {.callouttitle data-latex=""}
**Quantiles**
:::
\nopagebreak
...
col.names = c("Observation", "Symbol", "Observed value", "Deviation score $X_i - \\bar{X}$", "Absolute d.s. $|X_i - \\bar{X}|$"),
 booktabs = TRUE, escape = FALSE, format = "pandoc") %>%
  kableExtra::kable_styling(
    bootstrap_options = c("hover", "condensed", "responsive"),
    full_width = F,
    position = "center",
