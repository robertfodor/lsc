...
\usepackage[thref, framed, thmmarks, amsmath, amsthm]{ntheorem}
  ...
  % Definition
  \theoremprework{%
    \def\FrameCommand{{\color{chap}{\hspace{-12pt}\vrule width 3pt \hspace{9pt}}}}
  }
  ...
  % Example
  \theoremprework{%
    \def\FrameCommand{{\color{black}{\hspace{-11pt}\vrule width 1pt \hspace{10pt}}}}
  }
  \theoremstyle{break}
  \newframedtheorem{example}{Example}[chapter]
