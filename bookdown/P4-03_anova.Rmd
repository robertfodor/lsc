...
There's an interesting blog post^[http://daniellakens.blogspot.com.au/2015/06/why-you-should-use-omega-squared.html] by Daniel Lakens suggesting that eta-squared itself is perhaps not the best measure of effect size in real world data analysis, but rather **omega-squared** is. CogStat also opts for omega-squared ($\omega^2$) as the default measure of effect size in one-way ANOVA.
