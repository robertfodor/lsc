...
```{r ttesttherapy, echo=FALSE, fig.cap="CogStat results for the `therapy` model.", fig.align="center", out.width="100%", fig.show="hold"}
knitr::include_graphics(c(
...
But hang on, what is the story with the $F$ and $t$ stastistics? Actually, there is a fairly straightforward relationship here. If we square the $t$-statistic:
$$
1.3068 ^ 2
$$
