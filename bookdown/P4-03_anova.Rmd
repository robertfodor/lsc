...
```{r anovavara, fig.cap=paste("(ref:anovavaracap)"), echo=FALSE, fig.align="center", out.width="100%"}
	width <- 7
	height <- 4
	# params
	mu <- c(-4, -.25, 3.5)
...
```{r anovavarb, fig.cap=paste("(ref:anovavarbcap)"), echo=FALSE, fig.align="center", out.width="100%"}
width <- 7
	height <- 4
...
```{r cogcompbydrugdialog, echo=FALSE, fig.align="center", out.width="100%", fig.show="hold", fig.cap=paste("(ref:cogcompbydrugdialogcap)")}
...
```{r cogcompbydrugdescr, echo=FALSE, fig.align="center", out.width="100%", fig.show="hold", fig.cap=paste("(ref:cogcompbydrugdescrcap)")}
knitr::include_graphics(c(
    "resources/image/moodbydrug.png"))
```
...
```{r cogcompbydrug, echo=FALSE, fig.align="center", out.width="100%", fig.show="hold", fig.cap=paste("(ref:cogcompbydrugcap)")}
knitr::include_graphics(c(
...
```{r moodgainfreq, echo=FALSE, fig.cap=paste("(ref:moodgainfreqcap)"), fig.align="center", out.width="100%"}
