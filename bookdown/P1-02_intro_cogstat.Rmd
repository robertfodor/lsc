...
To install CogStat, you need to download the latest version from the [CogStat website](http://cogstat.org). The installation is straightforward and should not take more than a few minutes. To get help on installation, please visit our [GitHub page](https://github.com/cogstat/cogstat/wiki/Installation).
