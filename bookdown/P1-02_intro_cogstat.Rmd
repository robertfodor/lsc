...
Use the Wiki on our [GitHub page](https://github.com/cogstat/cogstat/wiki/Documentation-for-users) to find out more on how to get started to use Cogstat, e.g. how to prepare your data prior to loading, how to load the data, etc. With regards to the analysis and testing features, hold on to your hat and read on!