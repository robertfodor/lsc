...
```{r srs2, fig.cap=paste("(ref:srs2caption)"), echo=FALSE, fig.align='center', out.width='100%'}
...
```{r sampdistmean, fig.cap=paste("(ref:sampdistmeancap)"), echo=FALSE, fig.align="center", out.width="100%"}
...
```{r sampdistmax, fig.cap=paste("(ref:sampdistmaxcap)"), echo=FALSE, fig.align="center", out.width="100%"}
...
```{r sampdistsd, fig.cap=paste("(ref:sampdistsdcap)"), echo=FALSE, fig.align="center", out.width="100%"}
...
```{r cirep, fig.cap=paste("(ref:cirepcap)"), echo=FALSE, fig.align='center', out.width='100%', fig.show="hold"}
