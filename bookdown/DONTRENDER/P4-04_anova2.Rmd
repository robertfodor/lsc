...
```{r, eval=knitr::is_html_output(), echo=FALSE}
    ...
    group_rows(group_label = "Placebo", start_row = 1, end_row = 2) %>%
    group_rows(group_label = "Anxifree", start_row = 3, end_row = 4) %>%
    group_rows(group_label = "Joyzepam", start_row = 5, end_row = 6)
```
...
knitr::kable(
    ...
    group_rows("... - placebo-no_therapy", 1, 5) %>%
    group_rows("... - anxifree-no_therapy", 6, 9) %>%
    group_rows("... - joyzepam-no_therapy", 10, 12) %>%
    group_rows("... - placebo-CBT", 13, 14) %>%
    group_rows("... - anxifree-CBT", 15, 15)
```
