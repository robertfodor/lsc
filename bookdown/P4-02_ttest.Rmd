...
```{r chico, fig.cap=paste("(ref:chicocap)"), echo=FALSE, fig.align="center", out.width="100%", fig.show="hold"}
...
```{r swdist, fig.cap=paste("(ref:swdistcap)"), echo=FALSE, fig.align="center", out.width="100%"}
...
```{r mwafl24, echo=FALSE, fig.align="center", out.width="100%", fig.show="hold", fig.cap=paste("(ref:mwafl24cap)")}
